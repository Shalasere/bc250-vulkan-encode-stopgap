...
## 33. Odd resolutions in the host drift oracle: the padding was fine, the buffers were not
...
### 33.1 The oracle could not see a wrong crop window at all
...
### 33.2 A silently truncated slice, and it is not about resolution
...
### 33.3 ASan/UBSan across odd sizes — and the overrun this tree had inherited
...
### 33.4 The case set, and what is deliberately excluded
...
640x358 at QP 0 (the regression guard for §33.2 — not a resolution case),
