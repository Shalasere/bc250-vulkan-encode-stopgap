...
- **Quality is currently limited by the `qp_min=12` floor**, not by bandwidth or throughput: at 1440p/31 Mbps requested the encoder settles at QP 12, spends only ~15-19 Mbps, and has spare frame-time headroom (~65 fps encode ceiling vs 45-60 achieved). Lowering the floor is the next quality lever. `docs/DEVLOG.md` §16.5/§17.3.
